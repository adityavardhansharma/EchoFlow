...
class OpenRouterService(private val context: Context) {
    ...
    private val fusionRunner by lazy {
        OpenRouterFusionRunner(::postForResponse, ::buildMessagesPayload, ::applyInferenceParams)
    }
    ...
    fun sendWithEchoTools(
        ...
        if (fusion != null) {
            ...
            val (analysis, answer, reasoning, annotations) = fusionRunner.run(
                apiKey = apiKey,
                model = model,
                history = history,
